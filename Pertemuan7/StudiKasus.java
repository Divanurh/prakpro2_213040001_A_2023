    ...
    public StudiKasus() {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                {
                    JOptionPane.showMessageDialog(StudiKasus.this,"Nama, Nomor HP dan Alamat Wajib diisi!", "WARNING!",JOptionPane.ERROR_MESSAGE);
                    return;
                } else {
                    if(nama.equalsIgnoreCase(""))
                    {
                    JOptionPane.showMessageDialog(StudiKasus.this,"Nama belum terisi!", "WARNING!",JOptionPane.ERROR_MESSAGE);
                    return;
                    }
                    if(noHp.equalsIgnoreCase(""))
                    {
                    JOptionPane.showMessageDialog(StudiKasus.this,"Nomor HP belum terisi!", "WARNING!",JOptionPane.ERROR_MESSAGE);
                    return;
                    }
                    if(alamat.equalsIgnoreCase(""))
                    {
                    JOptionPane.showMessageDialog(StudiKasus.this,"Alamat belum terisi!", "WARNING!",JOptionPane.ERROR_MESSAGE);
                    return;
                    }
                }
                ...
                {
                    JOptionPane.showMessageDialog(StudiKasus.this,"Data anda sudah disimpan.");
                    ...
                    JOptionPane.showMessageDialog(StudiKasus.this,"Data anda tidak disimpan.");
                    textAreaAlamat.setText("");
                    textField.setText("");
                    textFieldNo.setText("");
                }
                ...
                if (selectedRow != -1) {
                    ...
                    if (confirmation == JOptionPane.YES_OPTION) {
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(StudiKasus.this, "Gagal menghapus data dari file.txt", "Error", JOptionPane.ERROR_MESSAGE);
                        }
                    ...
                    JOptionPane.showMessageDialog(StudiKasus.this, "Pilih baris yang ingin dihapus terlebih dahulu.", "Peringatan", JOptionPane.WARNING_MESSAGE);
                }
            }
        });
        ...
        buttonFile.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    fileWriter.close();
                    JOptionPane.showMessageDialog(StudiKasus.this, "Data telah disimpan.");
                } catch (IOException ex) {
